    ...
    <main>
		<section>
			...
			<div id="hero" class="bg-image vh-100 shadow-6-strong">
				<img src="src/images/banner/style2/banner-4.jpg" alt="HeroBild">
		...
		<!--section id="karriere" class="py-5">
			<div class="container-xxl">
				<div class="text-center">
					<p class="h1 p-4 p-md-3">Stellenausschreibungen</p>
					<br><br>
				<h3>aktuelle Stellenauschreibungen findest du <a href="/karriere">hier.</a></h3>
				</div>
			</div>
		</section-->
		<!--Über uns-->
		<!-- About 2 - Bootstrap Brain Component -->
		<section class="py-3 py-md-5 py-xl-8 bg-default">
			<?php
